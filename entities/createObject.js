...
export default function createObject(x, y, color , width, height, states, particles, offset, speed, sx, sy, canCollide, tag){
   ...
   object.addComponent('state', new StateComponent(canCollide, tag));
