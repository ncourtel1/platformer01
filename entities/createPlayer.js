...
export default function createPlayer(x, y, vx, vy, color, width, height, states, particleStates, sounds, maxHealth, health, score){
   ...
   player.addComponent('score', new ScoreComponent(score))
