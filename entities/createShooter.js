...
export default function createShooter(x, y, color , width, height, states, particles, offset, speed, canCollide, projectile){
   ...
   object.addComponent('sprite', new SpriteComponent(states, particles, offset, speed, undefined, undefined))
   object.addComponent('projectile', new ProjectileComponent(projectile));
